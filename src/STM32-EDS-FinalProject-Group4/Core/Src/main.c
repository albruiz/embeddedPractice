...
uint8_t msg1[] = "****** Temperature & Humidity values measurement ******\n\n\r";
uint8_t msg2[] = "=====> Initialize Temperature/Humidity sensor HTS221 \r\n";
uint8_t msg3[] = "=====> Temperature/Humidity sensor HTS221 initialized \r\n ";
/* USER CODE END PV */
